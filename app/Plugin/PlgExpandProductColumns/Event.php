...
use Plugin\PlgExpandProductColumns\Repository\PlgExpandProductColumnsValueRepository;
use Plugin\PlgExpandProductColumns\ServiceProvider\PlgExpandProductColumnsServiceProvider;
...
class Event
{
    ...
    public function productCopy(EventArgs $args)
    {
        $old_product_id = intval($args->getRequest()->attributes->get('id'));
        $new_product_id = $args->getArgument('CopyProduct')->getId();

        /**
         * @var $repository PlgExpandProductColumnsValueRepository
         */
        $repository = $this->app['orm.em']->getRepository('\Plugin\PlgExpandProductColumns\Entity\PlgExpandProductColumnsValue');
        $data_list = $repository->findBy([
            'productId' => $old_product_id
        ]);

        /**
         * @var $record PlgExpandProductColumnsValue
         */

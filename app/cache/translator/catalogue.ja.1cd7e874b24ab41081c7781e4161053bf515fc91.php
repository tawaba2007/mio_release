...
恐れ入りますがお問い合わせページよりお問い合わせください。',
    ...
    'plugin.related_product.type.comment.placeholder' => '説明文を入力してください(HTMLタグ使用可)。',
    'plugin.sales_report.type.monthly.error' => '集計月を選択してください。',
    'plugin.sales_report.type.term_start.error' => '集計期間を正しく選択してください。',
    'admin.uagaeec.save.complete' => '設定を保存しました。',
    'admin.uagaeec.save.error' => '設定を保存できませんでした。',
    'admin.uagaeec.form.is_invalid' => '設定の入力が正しくありません。',
  ),
));

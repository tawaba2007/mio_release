...
class Category extends \Eccube\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function hasProductCategories()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasProductCategories', array());
